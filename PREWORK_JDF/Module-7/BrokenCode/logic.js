...
$("#factButton").on("click", function() {
	//Generate a random number between 0 and 5 ( the number of facts in the booFactArray)
	var number = Math.floor((Math.random() * booFactsArray.length));
	//Display the fact from the booFactArray that is the the random position we just generated.
...
//Whent the shrinkBox button is pressed...
